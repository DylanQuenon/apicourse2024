...
#[ApiResource(
    uriTemplate:'/customers/{id}/invoices', //adresse exploitée
    uriVariables:[
        "id"=> new Link(fromClass:Customer::class,fromProperty:'invoices') //varuable liaison eentity customer et propriété invoices
...
class Invoice
{
  ...
  /**
   * Permet de récupérer le user a qui appartient la finacture
   *
   * @return User
   */
  #[Groups(['invoices_read','invoices_subresource'])]
